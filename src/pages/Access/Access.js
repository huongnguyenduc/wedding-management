  ...
  return (
    <MuiThemeProvider theme={theme}>
      <div className={classes.root}>
        {privileges.some(canShowUser) && privileges.some(canShowPer) ? (
        ...
        {privileges.some(canShowUser) ? (
          <TabPanel value={value} index={privileges.some(canShowPer) ? 1 : 0}>
            {props.users ? (
              <Account data={props.users} />
            ) : (
              <CircularProgress />
            )}
          </TabPanel>
