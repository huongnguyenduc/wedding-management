import {Paper, Snackbar, Table, TableBody, TableCell, TableContainer, TableHead,TableFooter,TablePagination, TableRow, TableSortLabel, Typography, Toolbar, TextField, IconButton, Grid} from "@material-ui/core"
...
function Row(props){
    ...
    function FinishHandler()
    {
        ...
        if(resultCheck.value)
        {
            if(shift)
            {
                const shiftData = {id:rowState.id, name:rowState.name, timeBegin:rowState.timeBegin, timeEnd:rowState.timeEnd}
                dispatch(UpdateShift(shiftData,Success))
            }
            else
            {
                
                const shiftData = {name:rowState.name, timeBegin:rowState.timeBegin, timeEnd:rowState.timeEnd}
    ...
    {
        setRowState({...rowState,id:shift.id,name:shift.name, timeBegin:shift.timeBegin,timeEnd:shift.timeEnd, editing:false})
    }
