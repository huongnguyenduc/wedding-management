...
function Login() {
  ...
  return (
    <Grid
      ...
      style={{ backgroundImage: `url(${ProBackground})` }}
    >
      <link rel="preconnect" href="https://fonts.gstatic.com" />
      <link
        href="https://fonts.googleapis.com/css2?family=Mitr&family=Pacifico&display=swap"
        rel="stylesheet"
      />
      ...
      <Container maxWidth="lg" className={classes.LoginContainer}>
        ...
        <Grid item xs={12} sm={6} md={5} lg={5} className={classes.TextContent}>
          ...
          <Grid>
            ...
            <Typography
              style={{ visibility: status.open ? "visible" : "hidden" }}
            ...
            <Container maxWidth="xs" className={classes.LoginForm}>
              ...
              <Grid className={classes.ButtonContainer}>
                <Button className={classes.btnLogin} onClick={LoginHandler}>
                  Đăng nhập
                </Button>
              </Grid>
            </Container>
          ...
          <Typography className={classes.HiddenTitle}>
            Quản lý tiệc cưới
          </Typography>
        </Grid>
      </Container>
