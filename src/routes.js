...
const routes = [
  ...
  },
  {
    ...
    exact: true,
    main: () => {
      if (getCookie("token") !== "") return <Calendar />;
  ...
  },
  {
    ...
    exact: true,
    main: () => {
      if (getCookie("token") !== "") return <Service />;
      else return <Redirect to="./Login" />;
    },
  },
  {
    ...
    exact: true,
    main: () => {
      if (getCookie("token") !== "") return <Policy />;
      else return <Redirect to="./Login" />;
    },
  },
  {
    ...
    exact: true,
    main: () => {
      if (getCookie("token") !== "") return <Food />;
      else return <Redirect to="./Login" />;
    },
  },
  {
    ...
    exact: true,
    main: () => {
      if (getCookie("token") !== "") return <Lobby />;
      else return <Redirect to="./Login" />;
    },
  },
  {
    ...
    exact: true,
    main: () => {
      if (getCookie("token") !== "") return <Wedding />;
      else return <Redirect to="./Login" />;
    },
  },
  {
    ...
    exact: true,
    main: () => {
      if (getCookie("token") !== "") return <Bill />;
      else return <Redirect to="./Login" />;
    },
  },
  {
    ...
    exact: true,
    main: () => {
      if (getCookie("token") !== "") return <Access />;
      else return <Redirect to="./Login" />;
    },
  },
  {
    ...
    exact: true,
    main: () => {
      if (getCookie("token") !== "") return <Promotion />;
      else return <Redirect to="./Login" />;
    },
  },
  {
